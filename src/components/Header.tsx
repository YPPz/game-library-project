...
// export default function Header() {
//   const [activeLink, setActiveLink] = useState<string | null>(null); //ช่วยให้รู้ว่าปุ่มไหนโดนคลิกจะได้ใส่ effect ตอนคลิก
...
//             <img src={HomeIcon} alt="Home" className="w-10 h-10 sm:w-12 sm:h-12 object-contain" />
//           </Link>
...
//           <button className="text-sm sm:text-base font-medium hover:text-blue-600 text-gray-800 dark:text-gray-200">
//             Menu
//           </button>
//         </div>
//       </div>
